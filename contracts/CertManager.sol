...
contract CertManager {
    ...
    */
    function viewPersonalCertByToken(string memory _tokenId) checkTokenAddress(_tokenId) public view returns(string memory, string memory, string memory, string memory, string memory, string memory) {
    ...
    /**
    * student can see his personal cert info & issuer can also see its personal cert which belongs to the issuer
    * return string: certTypeName
    * return string: issuerName
    * return string: descUrl (for certType)
    * return string: certNo
    ...
    */
    function viewPersonalCertByCertId(string memory _certId) public view returns(string memory, string memory, string memory, string memory, string memory, string memory, bool) {
        require( personalCerts[_certId].ownerAddress == msg.sender || owner == msg.sender || certTypes[personalCerts[_certId].certTypeId].issuerAddress == msg.sender );
